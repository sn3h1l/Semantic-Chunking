...
# @title 🚀 Run Semantic Chunking Pipeline { display-mode: "form" }
...
def process_video(url: str):
    ...
    print("=" * 60)
    print("🎬 YOUTUBE SEMANTIC CHUNKING PIPELINE")
    print("=" * 60)
    ...
    try:
        ...
        # Step 3: VAD
        print("\n🎙️ Step 3: Applying Voice Activity Detection...")
...
print(f"⏱️ Average Duration: {np.mean([c['chunk_length'] for c in chunks]):.1f}s")
print(f"📏 Duration Range: {min(c['chunk_length'] for c in chunks):.1f}s - "
...
print(f"📄 Total chunks: {len(formatted_output)}")
